...
@section('titulo-ref', 'Modificar Producto')
...
@section('contenido-lista')
    <div class="panel-container show">
        ...
        <div class="panel-content">
            ...
            {!! Form::model($producto,['route' => ['producto.update',$producto->id_producto], 'method' => 'PUT', 'class' => 'needs-validation']) !!}
    ...
    <!-- 
            {!! Form::submit('Guardar', ['name' => 'guardar', 'id' => 'guardar', 'class' => 'btn btn-primary ml-auto']) !!}
